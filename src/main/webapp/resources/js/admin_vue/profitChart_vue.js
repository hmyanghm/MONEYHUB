...
profitChart_vue ={
	...
	profitChart_body : ()=>{
		...
		'  <script src="/resources/js/adminChart/chart-area-feedb.js"></script>'+
		'  <script src="/resources/js/adminChart/chart-pie-member.js"></script>'+
		'  <script src="/resources/js/adminChart/chart-bar-demo.js"></script>'+
		'</body>'
	}
}